...
public class CourseContentController {
    ...
    @Autowired
    private CourseContentService courseContenService;
    ...
    public ResponseResult saveLesson(@RequestBody CourseLesson courseLesson) {
        ...
        if(courseLesson.getId()==null) {
            ...
            responseResult.setMessage("新增课时成功");
        } else {
            courseContenService.updateLesson(courseLesson);
            responseResult.setMessage("修改课时成功");
        }
        return responseResult;
    }
